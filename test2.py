...
'''new_agent = Agent(ch1.skizo, "example", "llama3.2", 16)
deepSeek_Agent = Agent(ch1.skizo, "example_deepseek", "deepseek-r1:1.5b")'''
...
alyssa_agent = Agent(ch1.alyssa_character, "example2", "llama3.2")
